...
export type CodecEncoderLike<EncodedType = string, EncodeOptions extends object = object, MetadataType = unknown> =
    CodecEncoder<EncodedType, EncodeOptions, MetadataType>
