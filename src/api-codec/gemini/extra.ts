...
export function getMessageExtraGemini(message: Pick<Message, 'extra'>, init?: boolean) : GeminiExtra|null;
export function getMessageExtraGemini(message: Pick<Message, 'extra'>, init: true) : GeminiExtra;
export function getMessageExtraGemini(message: Pick<Message, 'extra'>, init = false): GeminiExtra|null {
